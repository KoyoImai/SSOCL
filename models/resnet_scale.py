...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_planes, planes, downsample=None, stride=1, is_last=False):
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, planes, num_blocks, stride):
        ...
        layers.append(block(self.in_planes, planes, downsample=ii_downsample, stride=stride))
...
class ResNetProjectorHead(nn.Module):
    ...
    def __init__(self, name='resnet50', seed=777, cfg=None):
        ...
        self.head = nn.Sequential(
            ...
            nn.Linear(dim_in, cfg.model.feat_dim),
        )
    ...
    def forward(self, x, norm=True):
        ...
        feature_pre = self.head(encoded)
        feature = F.normalize(feature_pre, dim=1)
